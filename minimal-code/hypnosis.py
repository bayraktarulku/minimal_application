# So this code blog was written for nonsense . it serves no purpose.
...
priorities_and_sentences = [
    ...
    (3, 'and how much more ...comfortable...it will feel when \
    you let your neck relaxes ...and your head begins to \
    fall forward ...into a much more comfortable'),
]

scriptlist = [{'priority': j[0], 'text': j[1],
               'length': len(j[1]), 'index': i
               } for i, j in enumerate(priorities_and_sentences)]
...
print(as_text(truncate(100, scriptlist)))
