funny_words = [
    'aardvark', 'abacus', 'abundance', 'ache', 'acupuncture',
    ...
    'disk', 'disco duck', 'dodo', 'dolphin', 'dong', 'donuts', 'dork',
    ...
    'puzzle', 'queer', 'query', 'radish', 'rainbow', 'ribbon', 'rotate',
...
tdk = ['amblem - belirtke', 'anchorman - ana haber sunmak',
       'aspiratör - emmeç', 'banliyö - yörekent', 'bypass - köprüleme',
       'billboard - duyurumluk', 'çip - yonga', 'dart - oklama',
       'duayen - aksakal', 'ekspres - özel ulak', 'eküri - ahırdaş',
       'gurme - tatbilir', 'happy hour - indirim saatleri',
       'kapora - güvenmelik', 'klip - görümsetme', 'light - yeğni',
       'lot - tutam', 'metroseksüel - bakımlı erkek',
       'migren - yarım baş ağrısı', 'navigasyon - yolbul',
       'ordövr - yemekaltı', 'panik - ürkü', 'prime time - altın saatler',
       'raket - vuraç', 'reenkarnasyon - ruh göçü', 'self-servis - seçal',
       'sürpriz - şaşırtı', 'terör - yıldırı', 'tirbuşon - burgu',
       'tribün - sekilik', 'türbülans - burgaç', 'ultrason - yansılanım',
       'voleybol - uçan top', 'zapping – geçgeç '
]

def select_word_list(lang=None):
    word_list = tdk if lang == 'tr' else funny_words
    return word_list
