...
class Snake(QWidget):
    ...
    def keyPressEvent(self, e):
        if not self.isPaused:
            if e.key() == Qt.Key_Up and self.lastKeyPress != 'UP' \
                and self.lastKeyPress != 'DOWN':
                print('DOWN')
                self.direction('UP')
                self.lastKeyPress = 'UP'
            elif e.key() == Qt.Key_Down and self.lastKeyPress != 'DOWN' \
                and self.lastKeyPress != 'UP':
                print('UP')
                self.direction('DOWN')
                self.lastKeyPress = 'DOWN'
            elif e.key() == Qt.Key_Left and self.lastKeyPress != 'LEFT' \
                and self.lastKeyPress != 'RIGHT':
                print('RIGHT')
                self.direction('LEFT')
                self.lastKeyPress = 'LEFT'
            elif e.key() == Qt.Key_Right and self.lastKeyPress != 'RIGHT' \
